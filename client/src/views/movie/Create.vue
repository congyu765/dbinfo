<template>
  <div>
    <base-Box :type="'primary'" :title="'新增信息'">
      <el-form :model="form" :rules="rules" ref="movie-form" label-width="120px">
        <el-row>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item  label="电影年份" prop="imdb_id">
              <el-input v-model="form.imdb_id" placeholder="请输入电影年份"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="电影IMDB ID" prop="year">
              <el-input v-model="form.year" placeholder="请输入电影IMDB ID"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="24">
            ...
            native-type="submit" @click.prevent="submit('movie-form')">保存</el-button>
    ...
    submit (formName) {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          this.$message({
            message: '信息保存成功!页面将在2秒后跳转到信息列表页',
            type: 'success',
            duration: 2000,
            onClose: () => {
